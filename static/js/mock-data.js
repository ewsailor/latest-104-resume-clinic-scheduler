 ...
 * Mock 資料模組
 * 
 * 包含 Giver 的模擬資料，用於前端直接載入，無需 API 請求
 */
...
const MOCK_GIVERS = [
  ...
  },
  {
    ...
    "school": "世新大學",
    "tag": ["數據分析", "雲端技術", "產品規劃"],
    "introduction": "上善若水 水善利萬物而不爭，處眾人之所惡，故幾於道。居，善地；心，善淵；與，善仁；言，善信；政，善治；事，善能；動，善時。夫唯不爭，故無尤。～共勉之～",
  },
  {
    "id": 10,
...
const MOCK_API_RESPONSE = {
  results: MOCK_GIVERS,
  total: MOCK_GIVERS.length,
  page: 1,
  per_page: MOCK_GIVERS.length,
  total_pages: 1
};

// 匯出給其他模組使用
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { MOCK_GIVERS, MOCK_API_RESPONSE };
}
